    ...
    <div class="container-sm align-items-center">
        ...
        <div class="container-sm d-flex align-items-center border border-primary-2 rounded py-3">
            <div class="container aling-self-center">
                <div class="container-sm d-flex align-items-center border border-primary-2 rounded py-3">
                    <div class="container aling-self-center">
                        ...
                        <div class="row row-cols-auto d-flex align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#insertarProcesador" href="#">Procesador</a></li>
                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#insertarDiscoInterno" href="#">Discos Internos</a></li>
                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#insertarRAM" href="#">Memorias Ram</a></li>
                                        <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#insertarPB"
                                                href="#">Placa Base</a></li>
                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#insertarOtro" href="#">Otro</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <input type="text" id="inputFilter" class="form-control"
                                    aria-label="Busqueda por Parametros">
                            </div>
                        </div>
                    </div>
                </div>

                <div class="modal fade" id="insertarOtro" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <form action="prueba.php?p=gestion_equipos_componentes\componentes\gestion_componentes"
                                ...
                                <div class="modal-body">
                                    <div class="container-sm">
                                        <input type="hidden" name="selectComponente" id="selectComponente"
                                            value="form1">
                ...
                <!-- Modal -->
                <div class="modal fade" id="insertarProcesador" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="container-sm">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" aria-label="cpuSocket" name="cpuSocket"
                                                class="form-control">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Reloj Base</span>
                                            <input type="number" class="form-control" aria-label="cpuRelojBase"
                                                name="cpuRelojBase" aria-describedby="inputGroup-sizing-default">
                                            <span class="input-group-text">GHz</span>
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Hilos</span>
                                            <input type="number" class="form-control" aria-label="cpuHilos"
                                                name="cpuHilos" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                    </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="insertarPB" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                ...
                                <div class="modal-body">
                                    <div class="container-sm">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" aria-label="factorFormaPB" name="factorFormaPB"
                                                class="form-control">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">CPU Socket</span>
                                            <input type="text" aria-label="pbSocket" name="pbSocket"
                                                class="form-control">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Soporte Memoria</span>
                                            <input type="text" aria-label="soporteMemoria" name="soporteMemoria"
                                                class="form-control">
                                        </div>
                                        <div class="input-group mb-3">
                ...
                <!-- Modal -->
                <div class="modal fade" id="insertarRAM" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="container-sm">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" aria-label="ramMemoria" name="ramMemoria"
                                                class="form-control">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control"
                                                aria-label="ramVelocidadFrequencia" name="ramVelocidadFrequencia"
                ...
                <!-- Modal -->
                <div class="modal fade" id="insertarDiscoInterno" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="container-sm">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" required aria-label="discoCapacidad"
                                                name="discoCapacidad" class="form-control">
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Tipo Disco</span>
                                            <input type="number" required aria-label="idDisco" name="idDisco"
                                                class="form-control">
                                        </div>
                                    </div>
