...
<body>
    <div class="container-sm align-items-center">
        ...
        <!-- Modal (QR) -->
        <div class="modal" id="generarQR" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                ...
                <table class="table" id="infoEquipo">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($resultado)) {
                            ...
                            echo '<tr>';
                            echo '<td><a class="btn btn-outline-success" href="prueba.php?p=gestion_equipos_componentes/equipos/reporte_equipo&id=' . $id . '" role="button"> <span class="material-icons"> article </span> </a></td>';
                            echo '<td>' . $id . '</td>';
                            echo '<td>' . $nombre . '</td>';
    ...
    <script type="text/javascript">
        ...
        //     // Extract info from data-bs-* attributes
        //     var getID = qrButton.getAttribute('data-bs-whatever')
        //     // Update the modal's content.
