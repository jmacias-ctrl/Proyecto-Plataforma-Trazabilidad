...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['insertBoton'])) {
        ...
        if (mysqli_num_rows($r0) > 0) {
            $q1 = "INSERT INTO equipos VALUES (DEFAULT," . $id_departamento . ", " . $rut . ", '" . $nombre_equipo . "', '" . $fechaAdquisicion . "', '" . $costoaAdquisicion . "','" . $caracteristicasAdquisicion . "', '" . $formaaAdquisicion . "', inactivo);";
        ...
        <div class="container-xl d-flex flex-column border border-primary rounded">
            ...
            <div class="table-responsive caption-top">
                <table class="table" id="infoEquipo">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT id_equipo, nombre_equipo FROM equipos, edificios, departamentos, organizaciones WHERE equipos.id_departamento = departamentos.id_departamento 
