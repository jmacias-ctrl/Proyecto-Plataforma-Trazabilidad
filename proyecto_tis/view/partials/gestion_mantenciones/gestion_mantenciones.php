                ...
                <div class="row row-cols-auto d-flex align-items-center">
                    <div class="col-8">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#insertarMantenciones">
                        ...
                        <div class="modal-body">
                            <div class="container-sm">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" aria-label="nombre_mantencion" name="nombre_mantencion"
                                        class="form-control" required>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Tipo de
                                        Mantencion</span>
                                    <input type="text" class="form-control" aria-label="tMantencion" name="tMantencion"
                                        aria-describedby="inputGroup-sizing-default" required>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Fecha de
                                        Mantencion</span>
                                    <input type="date" class="form-control" aria-label="fMantencion" name="fMantencion"
                                        aria-describedby="inputGroup-sizing-default" required>
                                </div>
                                <div class="input-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Equipo a realizar
                                        mantencion</span>
                                    <select class="form-select" aria-label="equipoAMantencion" name="equipoAMantencion"
                                        required>
